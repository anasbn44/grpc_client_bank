...
public class BankGrpcClientTestBidirectional {
    public static void main(String[] args) throws IOException {
        ...
        StreamObserver<Bank.ConvertCurrencyRequest> fullStream = stub.fullStream(new StreamObserver<Bank.ConvertCurrencyResponse>() {
            @Override
